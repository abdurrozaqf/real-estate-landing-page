...
export default function About({}: AboutProps) {
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-between w-full px-0 lg:flex-row gap-y-4 md:px-16 lg:px-0">
        <MotionH1
        ...
        <MotionP
          className="flex-1 text-[14px] xl:text-base leading-loose xl:leading-loose text-neutral-300"
          initial={{ translateX: 100, opacity: 0.3 }}
          whileInView={{ translateX: 0, opacity: 1 }}
          transition={{ duration: 0.6 }}
        >
